(ns marketentry.registry
  ...
  own -- BLZ's flagship governor check
  (`marketentry.governor/struck-off-violations`) is a plain struck-off-
  Companies-Register-status boolean read off the engagement record, not
  a computed formula, so there is nothing here for it to call. This is
  a deliberate, honestly-reported difference in check SHAPE, not an
