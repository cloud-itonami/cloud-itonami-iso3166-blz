# cloud-itonami-iso3166-blz

Open ISO 3166 Blueprint for **BLZ**: Belize.
...
tax registration, and local-content rules in Belize, so the operator
...
- **Not the government of Belize.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Belizean-licensed counsel
...
(ISO 3166 `BLZ`). Required capabilities:
...
crafts, festivals and heritage sites for Belize:
